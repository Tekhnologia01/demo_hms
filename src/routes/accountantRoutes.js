...
const { GetAdmitedPatientBill, Paydeposite, GetCollectionReportDatewise, GetAdmitedPatientReceipt,addAccountant, GetAccountant, IpdBill, TodayDischargePatientList, ChangeAdmitedpatientSatuts, GetopdReportDatewise, PaymentHistory } = require("../controllers/acountantController");
